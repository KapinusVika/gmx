...
@XmlRootElement(name = "GroupTraining")
@XmlType(propOrder = { "name", "trainer", "clients", "duration"})
public class GroupTraining extends AbstractModel implements Serializable {
    private String name;
