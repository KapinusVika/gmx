...
public class AdressService extends BaseService{
    ...
    public static Adress createAdress(Adress adress) throws AgeClientException, InvalidDiscountException, InvalidCaloriesException, InvalidScheduleException, AgeTrainerException {
    ...
    public static Adress update(Adress adress) throws AgeClientException, InvalidDiscountException, InvalidCaloriesException, InvalidScheduleException, AgeTrainerException {
